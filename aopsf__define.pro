...
function AOpsf::Init, psf_fname, dark_fname, pixelscale, lambda, framerate, $
     	lmircam, roi=roi, badpixelmap_obj=badpixelmap_obj, label=label, store_radix=store_radix, recompute=recompute
    ...
    if not self->AOpsfAbstract::Init(psf_fname, dark_fname, pixelscale, lambda, framerate, $
    	lmircam, roi=roi, badpixelmap_obj=badpixelmap_obj, label=label, store_radix=store_radix, recompute=recompute) then return,0
