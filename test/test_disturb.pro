...
; Disturbance generation test.
;
; Slightly modified version of "batch_generate_disturb_doug.pro"
; that only calculates the first 4 disturbance frames.
;
; Test output is at the end of this file
